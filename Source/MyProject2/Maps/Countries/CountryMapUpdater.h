...
{
public:
	FCountryMapUpdater(FColor* CountriesColors, const TArray<int32>& PixelsToUpdate, const UProvince* Province, const TArray<int32>& Distances, const FVector2d& SizeVector, int CrossLineWidth);
