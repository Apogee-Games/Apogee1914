...
FAllianceMapUpdater::FAllianceMapUpdater(FColor* AlliancesColors, const TArray<int32>& PixelsToUpdate,
									   const UProvince* Province,const FColor NonAlignedCountryColor,const FColor NonAlliedCountryColor)
